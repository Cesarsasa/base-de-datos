...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `idProveedor` FOREIGN KEY (`idproveedor`) REFERENCES `proveedores` (`idproveedores`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `compras_detalle` (
  `idcompras_detalle` int NOT NULL AUTO_INCREMENT,
  `idcompra` int DEFAULT NULL,
  `idproducto` int DEFAULT NULL,
  `cantidad` int DEFAULT NULL,
  `precio_costo_unitario` decimal(8,2) DEFAULT NULL,
  PRIMARY KEY (`idcompras_detalle`),
  KEY `idcompras_idx` (`idcompra`),
  KEY `idproducto_idx` (`idproducto`),
  CONSTRAINT `idcompras` FOREIGN KEY (`idcompra`) REFERENCES `compras` (`idcompras`),
  CONSTRAINT `idproductos` FOREIGN KEY (`idproducto`) REFERENCES `productos` (`idproductos`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empleados` (
  ...
  CONSTRAINT `idPuestos` FOREIGN KEY (`idpuesto`) REFERENCES `puestos` (`idpuesto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `productos` (
  ...
  `precion_costo` decimal(8,2) DEFAULT NULL,
  ...
  CONSTRAINT `idmarcas` FOREIGN KEY (`idmarca`) REFERENCES `marcas` (`idmarcas`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `proveedores` VALUES (1,'nestle','12344','guatemala','54664576'),(2,'sarita','123456','guatemala','56784566'),(3,'ducal','543542','guatemala','54434567'),(4,'sully','431443','guatemala','34567890'),(5,'motufar','321321','guatemala','44324434');
...
INSERT INTO `puestos` VALUES (1,'encargado'),(2,'asistente'),(3,'gerente'),(4,'subgerente'),(5,'empleado');
...
CREATE TABLE `venta_detalles` (
  ...
  CONSTRAINT `idVentas` FOREIGN KEY (`idventas`) REFERENCES `ventas` (`idventas`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-12  0:31:27
